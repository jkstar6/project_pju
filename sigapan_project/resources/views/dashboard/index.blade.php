 ...
 <div class="container mx-auto px-4 py-8">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="/progres-pengerjaan" class="group bg-white p-6 rounded-xl shadow-sm border-l-4 border-red-500 flex flex-col justify-between min-h-[160px] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-slate-50">
           ...
           <a href="/tim-lapangan" class="group bg-white p-6 rounded-xl shadow-sm border-l-4 border-cyan-500 flex flex-col justify-between min-h-[160px] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-slate-50">
            <div>
                <div class="flex justify-between items-start">
                    <h4 class="text-gray-600 font-semibold text-sm">Tim Lapangan</h4>
                ...
                <h2 class="text-4xl font-bold text-gray-800 mt-2">26</h2>
            </div>
            <p class="text-gray-400 text-xs mt-4">Tim Survey dan Teknisi</p>
        </a>
            <a href="/tim-lapangan" class="group bg-white p-6 rounded-xl shadow-sm border-l-4 border-orange-500 flex flex-col justify-between min-h-[160px] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-slate-50">
            <div>
                <div class="flex justify-between items-start">
                    <h4 class="text-gray-600 font-semibold text-sm">User</h4>
                ...
                <h2 class="text-4xl font-bold text-gray-800 mt-2">64</h2>
            </div>
