...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/adamarnap/Desktop/www/html/kominfo-base-laravel-installer/sigapan_project/public/storage' => 'string',
            ...
            'laravelpwa.name' => 'string',
            'laravelpwa.manifest.name' => 'string',
            'laravelpwa.manifest.short_name' => 'string',
            'laravelpwa.manifest.start_url' => 'string',
            'laravelpwa.manifest.background_color' => 'string',
            'laravelpwa.manifest.theme_color' => 'string',
            'laravelpwa.manifest.display' => 'string',
            'laravelpwa.manifest.orientation' => 'string',
            'laravelpwa.manifest.status_bar' => 'string',
            'laravelpwa.manifest.icons.72x72.path' => 'string',
            'laravelpwa.manifest.icons.72x72.purpose' => 'string',
            'laravelpwa.manifest.icons.96x96.path' => 'string',
            'laravelpwa.manifest.icons.96x96.purpose' => 'string',
            'laravelpwa.manifest.icons.128x128.path' => 'string',
            'laravelpwa.manifest.icons.128x128.purpose' => 'string',
            'laravelpwa.manifest.icons.144x144.path' => 'string',
            'laravelpwa.manifest.icons.144x144.purpose' => 'string',
            'laravelpwa.manifest.icons.152x152.path' => 'string',
            'laravelpwa.manifest.icons.152x152.purpose' => 'string',
            'laravelpwa.manifest.icons.192x192.path' => 'string',
            'laravelpwa.manifest.icons.192x192.purpose' => 'string',
            'laravelpwa.manifest.icons.384x384.path' => 'string',
            'laravelpwa.manifest.icons.384x384.purpose' => 'string',
            'laravelpwa.manifest.icons.512x512.path' => 'string',
            'laravelpwa.manifest.icons.512x512.purpose' => 'string',
            'laravelpwa.manifest.splash.640x1136' => 'string',
            'laravelpwa.manifest.splash.750x1334' => 'string',
            'laravelpwa.manifest.splash.828x1792' => 'string',
            'laravelpwa.manifest.splash.1125x2436' => 'string',
            'laravelpwa.manifest.splash.1242x2208' => 'string',
            'laravelpwa.manifest.splash.1242x2688' => 'string',
            'laravelpwa.manifest.splash.1536x2048' => 'string',
            'laravelpwa.manifest.splash.1668x2224' => 'string',
            'laravelpwa.manifest.splash.1668x2388' => 'string',
            'laravelpwa.manifest.splash.2048x2732' => 'string',
            'laravelpwa.manifest.shortcuts.0.name' => 'string',
            'laravelpwa.manifest.shortcuts.0.description' => 'string',
            'laravelpwa.manifest.shortcuts.0.url' => 'string',
            'laravelpwa.manifest.shortcuts.0.icons.src' => 'string',
            'laravelpwa.manifest.shortcuts.0.icons.purpose' => 'string',
            'laravelpwa.manifest.shortcuts.1.name' => 'string',
            'laravelpwa.manifest.shortcuts.1.description' => 'string',
            'laravelpwa.manifest.shortcuts.1.url' => 'string',
            'laravelpwa.manifest.custom' => 'array',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/adamarnap/Desktop/www/html/kominfo-base-laravel-installer/sigapan_project/public/storage',
...
'laravelpwa.name','laravelpwa.manifest.name','laravelpwa.manifest.short_name','laravelpwa.manifest.start_url','laravelpwa.manifest.background_color',
'laravelpwa.manifest.theme_color','laravelpwa.manifest.display','laravelpwa.manifest.orientation','laravelpwa.manifest.status_bar','laravelpwa.manifest.icons.72x72.path',
'laravelpwa.manifest.icons.72x72.purpose','laravelpwa.manifest.icons.96x96.path','laravelpwa.manifest.icons.96x96.purpose','laravelpwa.manifest.icons.128x128.path','laravelpwa.manifest.icons.128x128.purpose',
'laravelpwa.manifest.icons.144x144.path','laravelpwa.manifest.icons.144x144.purpose','laravelpwa.manifest.icons.152x152.path','laravelpwa.manifest.icons.152x152.purpose','laravelpwa.manifest.icons.192x192.path',
'laravelpwa.manifest.icons.192x192.purpose','laravelpwa.manifest.icons.384x384.path','laravelpwa.manifest.icons.384x384.purpose','laravelpwa.manifest.icons.512x512.path','laravelpwa.manifest.icons.512x512.purpose',
'laravelpwa.manifest.splash.640x1136','laravelpwa.manifest.splash.750x1334','laravelpwa.manifest.splash.828x1792','laravelpwa.manifest.splash.1125x2436','laravelpwa.manifest.splash.1242x2208',
'laravelpwa.manifest.splash.1242x2688','laravelpwa.manifest.splash.1536x2048','laravelpwa.manifest.splash.1668x2224','laravelpwa.manifest.splash.1668x2388','laravelpwa.manifest.splash.2048x2732',
'laravelpwa.manifest.shortcuts.0.name','laravelpwa.manifest.shortcuts.0.description','laravelpwa.manifest.shortcuts.0.url','laravelpwa.manifest.shortcuts.0.icons.src','laravelpwa.manifest.shortcuts.0.icons.purpose',
'laravelpwa.manifest.shortcuts.1.name','laravelpwa.manifest.shortcuts.1.description','laravelpwa.manifest.shortcuts.1.url','laravelpwa.manifest.custom','logging.default',
...
'logout','laravelpwa.manifest','laravelpwa.','storage.local',);
...
'laravelpwa::meta','laravelpwa::meta','laravelpwa::offline','laravelpwa::offline','layouts.app',
'layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','vendor.laravelpwa.meta','vendor.laravelpwa.offline','welcome','breadcrumbs::bootstrap4',
...
'laravel-exceptions::minimal','laravelpwa::meta','laravelpwa::offline','notifications::email','pagination::bootstrap-4',
