...
@push('styles')
    ...
    <style>
        ...
        .modal-content { width: 100%; max-width: 760px; background: #fff; border-radius: 12px; overflow: hidden; }
        ...
        .btn-map{
            ...
            padding: 6px 10px; background-color: #eff6ff; color: #2563eb;
            border-radius: 6px; font-size: 11px; font-weight: 500;
            transition: all 0.2s;
        }
        .btn-map:hover { background-color: #dbeafe; color: #1d4ed8; }

        /* Badge Styling */
        .badge{ padding: 5px 12px; border-radius: 6px; font-size: 11px; font-weight: 500; display: inline-block; }
...
@section('content')
    @php
        // ✅ CRUD Log Survey hanya Admin + Survey
        $canManageLogSurvey = auth()->check() && auth()->user()->hasAnyRole(['Admin','Survey']);
    @endphp
    ...
    <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            ...
            {{-- ✅ tombol tambah hanya Admin + Survey --}}
                                    ...
                                    <td class="text-center">
                                        <div class="flex items-center gap-[10px] justify-center">
                                            ...
                                            <form action="{{ route('log-survey.destroy', $log->id) }}" method="post" class="inline">
                                                ...
                                                @method('delete')
                                                <button type="submit"
                                                    onclick="return confirm('Hapus data survey ini?')"
                                                    class="btn-icon text-danger-500"
                                                    title="Delete">
...
@push('scripts')
    ...
    <script>
        const CAN_MANAGE_LOG_SURVEY = @json($canManageLogSurvey);
        ...
        $(document).ready(function() {
            ...
            // ✅ Teknisi read-only: stop JS CRUD di sini
            if (!CAN_MANAGE_LOG_SURVEY) return;
